...
const DASHBOARD_HREF = "/super-admin/dashboard";

type SuperAdminManagementPageShellProps = {
  title: string;
  action?: ReactNode;
  children: ReactNode;
};

export function SuperAdminManagementPageShell({
  title,
  action,
  children,
}: SuperAdminManagementPageShellProps) {
  return (
