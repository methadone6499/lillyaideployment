...
type ReviewerUnsavedNotesDialogProps = {
  open: boolean;
  onConfirm: () => void;
  onCancel: () => void;
};

export function ReviewerUnsavedNotesDialog({
  open,
  onConfirm,
  onCancel,
}: ReviewerUnsavedNotesDialogProps) {
  ...
  return (
    ...
    >
      <div
        ...
        role="alertdialog"
        aria-modal="true"
        aria-labelledby="reviewer-unsaved-notes-title"
        aria-describedby="reviewer-unsaved-notes-description"
        tabIndex={-1}
